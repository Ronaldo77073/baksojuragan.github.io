            ...
            <form action="" method="post" enctype="multipart/form-data">
                <div>
                    ...
                    <input type="text" id="nama" name="nama" value="<?php echo $data['nama']; ?>" class="form-control"
                        autocomplete="off" placeholder="masukkan nama menu" required>
                </div>
                <div>
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <button type="submit" onclick="return confirm('apakah kamu yakin ingin menghapus menu ini?')"
                        class="btn btn-danger" name="hapus">Hapus</button>
                </div>
            </form>
