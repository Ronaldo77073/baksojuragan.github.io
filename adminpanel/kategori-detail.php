            ...
            <form action="" method="post">
                <div>
                    ...
                    <input class="form-control" type="text" name="kategori" id="kategori"
                        value="<?php echo $data['nama']; ?>" placeholder="masukkan nama kategori menu" required>
                </div>
                <div class="mt-5 d-flex justify-content-between">
                    <button type="submit" class="btn btn-primary" name="editBtn">Edit</button>
                    <button type="submit"
                        onclick="return confirm('apakah kamu yakin ingin menghapus kategori menu ini?')"
                        class="btn btn-danger" name="deleteBtn">Hapus</button>
                </div>
            </form>
